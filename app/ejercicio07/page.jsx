...
import { diccionario } from './objetos';
import { procesarContenido, readAndDisplayFile, mostrarPalabrasPorCategoria} from './funciones';
...
const Ejercicio07 = () => {
  ...
  const leerArchivo = (e)=>{
    ...
    if(file){
      ...
      const result = procesarContenido(text, setMensaje, diccionario);
      setResultado(result.join('\n'));
      setMensaje(`Se han encontrado ${result.length} tokens`);
      mostrarPalabrasPorCategoria(result, setCategoriasData);
    }; 
  };
...
const Limpiar = (e) =>{
  ...
  return (
    <div className = 'max-w-lg mx-auto mt-5'>
        <h1 className = 'text-center font-bold uppercase'>Analizador Lexico 3.0</h1>
