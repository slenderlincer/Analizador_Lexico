    ...
    const leerArchivo = (e)=>{
        ...
        if(file){
            ...
            filereader.onload = function(){
                ...
                const contenidoNuevo = data.match(/[a-zA-Z]/g)//Expresion regular para filtrar solo letras
                
                // Si se encontraron caracteres
                if(contenidoNuevo){
...
const Limpiar = (e) =>{
  ...
  return (
    <div className = 'max-w-lg mx-auto mt-5'>
        <h1 className = 'text-center font-bold uppercase'>Lector de archivos.txt, con RegExp 'a-zA-Z'</h1>
